...
Record({
    $id: Now.ID['6c62fa6b912546178d3f915f0c05347b'],
    ...
    data: {
        ...
        run_time: '2026-03-18 23:42:00',
        run_type: 'on_demand',
        script: `import { gs, GlideRecord, GlideDateTime } from '@servicenow/glide'
import { normalizeDealType } from '../script-includes/deal-type-normalizer.js'

export function remediateLegacyDealTypeCutover() {
...
function loadDealTypeCatalog() {
    ...
    while (typeGr.next()) {
        ...
        var code = normalizeDealType(typeGr.getValue('code'), '')
