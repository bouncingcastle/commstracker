...
UiPage({
    $id: Now.ID['e82b18c6eb2b4894ac6b8fabc0e44673'],
    category: 'general',
  ...
  <body>
    ...
    <script>(function(){
      ...
      <li>
        ...
        <span class="label">No plan selected</span>
        <span class="meta">Open from Plan Structure Reference and append ?sysparm_plan_id=
          <plan_sys_id>, or pick a plan from the active plans list below.</plan_sys_id>
        </span>
        ';
        actionsEl.innerHTML =
          '
