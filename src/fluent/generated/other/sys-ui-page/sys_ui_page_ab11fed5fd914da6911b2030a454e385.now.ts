...
UiPage({
    $id: Now.ID['ab11fed5fd914da6911b2030a454e385'],
    category: 'general',
  ...
  <body>
    <div class="container">
      ...
      <div class="grid">
        ...
        <div class="card metric">
          <div class="metric-label">✅ Locked $[AMP] Paid</div>
      ...
      <div class="big-card">
        ...
        <table class="list-table" id="calculationsTable">
          ...
          <tbody id="calcTableBody">
            <tr>
              <td colspan="7" style="text-align:center;padding:24px;color:var(--muted);">Loading...</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="foot">Data updates in real-time from commission calculations and deal records.
    Last updated:
