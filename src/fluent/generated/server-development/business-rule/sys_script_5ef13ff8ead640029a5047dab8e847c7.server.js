// @fluent-module validatePlanRecognitionPolicy;false;x_823178_commissio/x-823178-commission-m/1.0.0/src/server/business-rules/plan-recognition-policy-validation.js
...
const { validatePlanRecognitionPolicy } = require('x_823178_commissio/x-823178-commission-m/1.0.0/src/server/business-rules/plan-recognition-policy-validation.js');
validatePlanRecognitionPolicy(current, previous);